...
// Date     :     10-05-2010
// Desc     :     Class that holds data specific to an Loran import (if any)
// 
namespace RenRe.Doris.Data.Ssis
{
    public class LoranSsisImportScripter : SsisImportScripter
    {
        public LoranSsisImportScripter(string name, string importSchemaName, string path, string sourceConnectionString,
